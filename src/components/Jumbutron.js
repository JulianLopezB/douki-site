...
const Jumbutron = ({ children }) => {
  ...
  return (
    ...
    <div className="flex md:flex items-center py-10 ">
      <div className='max-w-md md:max-w-md mx-auto w-full'>
        ...
        <>
        <h1 class="text-gray text-left text-3xl font-bold mb-3 py-0">About</h1>
        ...
        <p className='text-gray text-left text-1xl  mb-5'>
          Dō ki uses OpenAi's CLIP (Contrastive Language–Image Pre-training) pretrained model, which is built on a large body of work on zero-shot transfer, natural language supervision, and multimodal learning.
          </p>
        <p>Images are sourced from Zara, Mango, H&M and Urban Outfitters latest collections</p>
        <p className='text-gray text-left text-1xl  mb-8'>
          Devloped by <a class="footer" href="https://ar.linkedin.com/in/julianlopezba">Julian Lopez Baasch</a>
          </p>
