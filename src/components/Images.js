        ...
        <div className="flex md:flex items-center py-3 px-6">
          ...
          <div class="flex space-x-2 justify-center">
            <div>
              ...
              <button type="button"  onClick={handleButtonSearch} value="60s Paris streets" class="inline-block px-6 py-2 border-2 border-purple-600 text-purple-600 font-medium text-xs leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out">60s Paris streets</button>
