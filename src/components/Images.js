        ...
        <div className="flex md:flex items-center py-3 px-6">
          ...
          <div class="flex space-x-2 justify-center">
            <div>
              ...
              <button type="button"  onClick={handleButtonSearch} value='What to wear at a beach wedding?' class="inline-block px-6 py-2 border-2 border-purple-600 text-purple-600 font-medium text-xs leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out">What to wear at a beach wedding?</button>
              ...
              <button type="button"  onClick={handleButtonSearch} value="Merlina Addams" class="inline-block px-6 py-2 border-2 border-purple-600 text-purple-600 font-medium text-xs leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out">Merlina Addams</button>
              ...
              <button type="button"  onClick={handleButtonSearch} value="Roaring 20s" class="inline-block px-6 py-2 border-2 border-purple-600 text-purple-600 font-medium text-xs leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out">Roaring 20s</button>
              <button type="button"  onClick={handleButtonSearch} value="70s fashion" class="inline-block px-6 py-2 border-2 border-purple-600 text-purple-600 font-medium text-xs leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out">70s fashion</button>
              <button type="button"  onClick={handleButtonSearch} value="Paris streets" class="inline-block px-6 py-2 border-2 border-purple-600 text-purple-600 font-medium text-xs leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out">Paris streets</button>
              <button type="button"  onClick={handleButtonSearch} value="New York streets" class="inline-block px-6 py-2 border-2 border-purple-600 text-purple-600 font-medium text-xs leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out">New York streets</button>
